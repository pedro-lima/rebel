package br.com.phoebus.rebel.api.services.galaxy;
...
public class GalaxyServiceImpl extends GenericServiceImp<Galaxy> implements GalaxyService {

	/**
	 * The repository of the galaxy
	 */
	@Autowired
	private GalaxyRepository repository;

	/**
	 * Get the repository of the galaxy
	 */
	protected GalaxyRepository getRepository() {
